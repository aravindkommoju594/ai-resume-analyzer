...
const feedbackText = typeof content === "string" ? content : Array.isArray(content) ? content[0]?.text : "";

if (!feedbackText) return setStatusText('Error: Failed to read analysis');
